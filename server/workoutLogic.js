...
const generateWorkoutPlan = (data) => {
    ...
    let sets = 3;
    let reps = "10-12";
    let restDayCount = 2; // Default, 5 days on
    ...
    if (goal === "strength") {
        ...
        sets = 5;
        reps = "5-8";
        restDayCount = 3; // More rest for strength
    ...
    for (const [day, details] of Object.entries(dailyStructure)) {
        ...
        if (details.type === "rest") {
            ...
            // Pick exercises based on type and goal
            // This is a simplified random picker from the allowed lists
